<template>
  <aside class="w-64 bg-gray-800 text-white flex flex-col shadow-lg">
    <div class="p-6 border-b border-gray-700 bg-gray-900">
      <h2 class="text-3xl font-bold text-indigo-400">User Panel</h2>
    </div>
    ...
    <nav class="flex-grow p-6">
      <ul>
        <li class="mb-3">
          <router-link to="/dashboard" class="flex items-center py-2 px-4 rounded-md hover:bg-gray-700 transition duration-200 ease-in-out">
            <Icon icon="mdi:view-dashboard" class="w-6 h-6 mr-3 text-indigo-300" />
            <span class="text-lg">Mi Dashboard</span>
          </router-link>
        </li>
        <!-- Puedes añadir más enlaces de navegación específicos para usuarios aquí -->
      </ul>
    </nav>
